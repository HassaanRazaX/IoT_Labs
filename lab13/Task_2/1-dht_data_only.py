...
INFLUXDB_TOKEN = "HyqbiSMV2BP-DAFIwOCmm7VdFz2zIDbv6DN0WNcc90SR4bjs-Wwz1a6zruSfQ8YlKojU-VeguxvOrvimLnCbqQ=="  # Replace with your InfluxDB token
INFLUXDB_ORG = "iotlab"      # Replace with your InfluxDB organization name
INFLUXDB_BUCKET = "lab13"  # InfluxDB bucket name

# MQTT setup
MQTT_BROKER = "10.13.44.90"  # ESP32's MQTT broker address
